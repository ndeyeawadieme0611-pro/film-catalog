...
function CustomTooltip({ active, payload, label }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "14px", fontWeight: "700", color: "#3d7cff" }}>
        {payload[0].value} films
      </div>
    </div>
  );
}
  ...
  return (
    <div className="fade-in">
      ...
      >
        ...
        <div className="card">
          <div
            style={{ fontSize: "15px", fontWeight: "700", marginBottom: "2px" }}
          >
            Ajouts par mois
          </div>
          <div
          ...
          >
            <span style={{ color: "#00d9b0", fontWeight: "600" }}>+22% </span>vs
            année précédente
          </div>
          <ResponsiveContainer width="100%" height={200}>
            ...
            >
              ...
              <XAxis
                dataKey="m"
                tick={{ fill: "rgba(200,210,255,0.35)", fontSize: 11 }}
                axisLine={false}
                tickLine={false}
              />
              <YAxis
          ...
          >
            <div
              style={{
                ...
                background:
                  i === 0
                    ? "linear-gradient(135deg,#f4a320,#ff6b35)"
            ...
            {favorites.some((fav) => fav.id === m.id) && (
              <div style={{ color: "#3d7cff", fontSize: "16px" }}>♥</div>
            )}
          </div>
        ))}
      </div>
